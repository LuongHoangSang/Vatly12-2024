...
\def\tren{1.65}\def\duoi{1.5}\def\trai{1}\def\phai{1} %cách lề
...
%%%%%%%%%%%%%
\def\trenphai{www.facebook.com/luonghoangsang99}
\def\hoten{Lương Hoàng Sang}
\def\SDT{09.6175.0612}
\def\duoiphai{\faFileText\, \hoten \,\,--\,\, \faPhoneSquare\ \SDT}
%--
%\def\trenphai{}
%\def\duoiphai{}
%%%%%%%%%%%%% Đn lại A.B.C.D
